...
function getStatistics(json){
    ...
    statisticsData.percentRepVoted = (statisticsData.republicans/members.length)*100;
    statisticsData.percentDemVoted = (statisticsData.democrats/members.length)*100;
    statisticsData.percentIndVoted = (statisticsData.independients/members.length)*100;
    statisticsData.percentTotalVoted = (totalMemberVoted/members.length)*100;
    /**
...
getStatistics(data.results[0].members);
...
//     foo.push({
//         "first_name": data.results[0].members[i].first_name,
//         "middle_name": data.results[0].members[i].middle_name,
//         "last_name": data.results[0].members[i].last_name,
//         "missed_votes": data.results[0].members[i].missed_votes,
...
// var gg = data.results[0].members[33].first_name + " " + (data.results[0].members[33].middle_name? data.results[0].members[33].middle_name + " " : "")
//  +data.results[0].members[33].last_name;
